...
import { FaHeart,FaEnvelope , FaLinkedin,FaGithub, FaInstagram, FaFacebook, FaArrowUp } from 'react-icons/fa'
import './Footer.css'
    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-bottom">
          <div >
            <img className="inlagn" id='my-profil' src="https://media.licdn.com/dms/image/v2/D5603AQG6I2SJYqbKtQ/profile-displayphoto-scale_400_400/B56Zwesln.HAAg-/0/1770041532486?e=1773273600&v=beta&t=O2O1N8Ct_pkMZQPNgg50uwOfLWCJCKQUVsvHS75lQss" alt="" />
            <div className="inlagn">
              <h4>El Amraoui Mounir</h4>
              <p>Étudiant en 2ème année Classe Préparatoire à l’ENSA Tanger ,</p>
              <p>Passionné de développement web et technologies modernes.  ❤️</p>
              
            </div>

          </div>
          <div className="footer-socials">
            <a href="https://www.linkedin.com/in/mounir-el-amraoui-42b3203aa/"><FaLinkedin /></a>
            <a href="mailto:mounir.el.amraoui186@gmail.com"><FaEnvelope  /></a>
            <a href="https://github.com/MounirElAmraoui"><FaGithub /></a>
          </div>
        </div>
      </div>
